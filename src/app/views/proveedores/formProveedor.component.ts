...
export class FromComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.proveedorService.getCiudades().subscribe(ciudades => this.ciudades = ciudades);
    this.proveedorService.getTipoDocumento().subscribe(tipos_documentos => this.tipos_documentos = tipos_documentos);
  ...
  create(): void {
    ...
    this.proveedorService.create(this.proveedor).subscribe(
      proveedor => {
        ...
        swal.fire('Nuevo proveedor', `El proveedor ${proveedor.nombre} ha sido creado con éxito`, 'success');
      },
      err => {
